...
#include "tensorflow/core/kernels/data/arrow_kernels.h"
...
#include "tensorflow/core/kernels/data/io_interface.h"
...
REGISTER_KERNEL_BUILDER(
    Name("ArrowReadableFromMemoryInit").Device(DEVICE_CPU),
    ArrowReadableFromMemoryInitOp);
REGISTER_KERNEL_BUILDER(Name("ArrowReadableSpec").Device(DEVICE_CPU),
                        ArrowReadableSpecOp);
REGISTER_KERNEL_BUILDER(Name("ArrowReadableRead").Device(DEVICE_CPU),
                        ArrowReadableReadOp);
